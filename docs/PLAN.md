...
- [ ] Refactor `apps/web` to consume `app-core` and `app-browser`
...
- [ ] Reuse `app-core` and `app-browser` instead of copying web logic
...
- [ ] Add boundary enforcement in CI for forbidden imports and package cycles

...
- [Live agent execution trace lab](./execution-trace.mdx) — another ready-made lab, built on this
...
- [Plugin & tool-picker impact lab](../plugins-and-tools/plugin-tool-picker-lab.mdx) — another

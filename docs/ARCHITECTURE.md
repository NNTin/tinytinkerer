...
The browser shell and the harness shell consume the same browser-facing shared layer; the harness shell additionally composes `app-harness` and its app-owned protocol.

...
// The PWA install banner (mobile presentation only). Injected into the shared docked
// chat body as an `installSlot` because it depends on @tinytinkerer/ui + heroicons,
// which the shared App package (app-browser) is not allowed to import.

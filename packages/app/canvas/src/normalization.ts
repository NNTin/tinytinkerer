...
import type { EditableField, EditRestriction, ProjectedElement, ReadElement } from './contracts'
import { EXCALIDRAW_FIELD_LIMITS } from './inputs'
import type { ElementField, ReadInput } from './inputs'

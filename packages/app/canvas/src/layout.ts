...
import type { LayoutFinding } from './contracts'
import { EXCALIDRAW_PAYLOAD_BUDGETS } from './inputs'
import type { ArrangeInput, PlaceInput, SnapInput, SurveyInput } from './inputs'
import {
  boxOf,
  boxesIntersect,
  combinedBox,
